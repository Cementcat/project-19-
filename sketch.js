...
function preload(){
  girl_running=loadAnimationjumpingAnimation = loadAnimation(
...
runningAnimation = loadAnimation(
  ...
  ground_image= loadImage('https://la-wit.github.io/build-an-infinite-runner/build/images/environments/industrialBackground.png');
